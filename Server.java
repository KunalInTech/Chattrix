...
public class Server implements ActionListener {   
    ...
    Server() {       
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Person.png"));
        ...
        more.setBounds(425, 23, 10, 25);
        p1.add(more);
        
        JLabel name = new JLabel("Elisa");
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBackground(new Color(166, 240, 141));
    ...
    public static void main(String[] args) {
        new Server();      
        try {
            ServerSocket skt = new ServerSocket(6006);
            while(true) {
                Socket s = skt.accept();
